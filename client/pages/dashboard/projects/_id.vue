    ...
    <section class="container mx-auto pt-8">
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="w-1/4 text-right">
          <nuxt-link to="/dashboard/projects/create" class="bg-green-button hover:bg-green-button text-white font-bold px-4 py-1 rounded inline-flex items-center"> Edit </nuxt-link>
        </div>
      </div>
        ...
        <div class="w-full lg:max-w-full lg:flex mb-4">
          <div class="border border-gray-400 bg-white rounded p-8 flex flex-col justify-between leading-normal">
            <div>
              ...
              <p class="text-sm font-bold flex items-center mb-1 mt-4">What Will Funders Get</p>
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="w-1/4 text-right">
          <a href="#" class="bg-green-button hover:bg-green-button text-white font-bold px-4 py-1 rounded inline-flex items-center"> Upload </a>
        </div>
      </div>
      <div class="flex -mx-2">
        ...
        <div class="w-full lg:max-w-full lg:flex mb-4">
          <div class="w-full border border-gray-400 lg:border-gray-400 bg-white rounded p-8 flex flex-col justify-between leading-normal">
            <div>
              ...
              <p class="text-sm text-gray-600 flex items-center mb-2">Rp. 200.000 &middot; 12 September 2020</p>
            </div>
          </div>
        </div>
      </div>
